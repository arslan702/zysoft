...
return( 
    ...
    <div className=''>
        ...
        <div className='text-center pt-28 ' >
            <div className='text-[#3C1B65] text-4xl font-semibold '>Services</div>
            <div className=' py-5 px-96 text-sm'>
                We are a leading IT firm focused to provide unique and customized solutions to businesses of all sizes. With our knowledge of modern technologies, we enable businesses to achieve success in today's digital age. Please allow us to introduce the products and services we provide to you.. 
            </div>
        </div>
  ...
  <div className="grid grid-cols-4 px-20 ">
    ...
    <div class="relative">
        <img src="https://www.linkpicture.com/q/Rectangle-6-3.png" />
        
        <div class="absolute text-xl text-black  font-semibold top-5 left-12  py-5 px-4" > 
            <div className='w-20 h-20 rounded-full bg-[#FB1D87] mx-12 my-2 '> 
                <img src="https://www.linkpicture.com/q/Group-480.png" alt="" />
            </div>
                 Web Development
            <div className='text-sm py-1 text-gray-800 pr-10'>
                Our experienced team of developers crafts dynamic and responsive websites that enhance your online.
            </div>
    ...
    <div class="relative">
        ...
        <div class="absolute text-xl text-black  font-semibold top-5 left-12  py-5 px-4" > <div className='w-20 h-20 rounded-full bg-[#9F37F0] mx-12 my-2 '>
        <img src="https://www.linkpicture.com/q/Group-470.png" alt="" />
        </div> App Development
        <div className='text-sm pr-10 py-1 text-gray-800'>With the help of our specialized mobile app development services, stay ahead of the mobile.</div>
        <span className=' px-10 text-sm hover:text-[#FB1D87]'>Learn More ...</span>
        </div>
    </div>
    ...
    <div class="relative">
        ...
        <div class="absolute text-xl text-black  font-semibold top-5 left-12 px-5 px-5 py-5" > <div className='w-20 h-20 rounded-full bg-[#9F37F0] mx-12 my-2 '> 
