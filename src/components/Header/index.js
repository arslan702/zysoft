    ...
    <div style={{ height: "230px", backgroundColor: "#F7F7FF" }}>
      <div className="flex flex-row">
        <div className="ml-100 pt-10" style={{marginLeft: '70px'}}>
          <Image src={'/images/group9.png'} alt="img" width={300} height={300} style={{height: '131px', width: '447px'}}/>
        </div>
        <div className="pt-10" style={{paddingLeft: '90px', marginTop: '20px'}}>
          <div className="font-normal font-bold text-4xl leading-tight" style={{fontWeight: '700', marginLeft: '20px'}}>
            {heading}
          </div>
          <div>{subHeading}</div>
        </div>
